...
Ratkaisu:
- 5.10. klo 7.17 Apache2-palvelin oli jo asennettuna, mutta jos se olisi pitänyt asentaa, olisin tehnyt sen komennolla `sudo apt-get install apache2`. Tarkistin Apache2:n tilanteen komennolla `sudo systemctl status apache2`, jossa näkyi, että tila on aktiivinen (_active (running)_).
